...
import { resolveChannelPreviewStreamMode, resolveChannelStreamingBlockCoalesce, resolveChannelStreamingBlockEnabled, resolveChannelStreamingChunkMode } from "openclaw/plugin-sdk/channel-streaming";
...
import { z } from "zod";
//#region src/mattermost/client.ts
...
//#endregion
//#region src/mattermost/accounts.ts
const mattermostAccountHelpers = createAccountListHelpers("mattermost-pro", { hasImplicitDefaultAccount: (cfg) => {
	const mattermost = cfg.channels?.["mattermost-pro"];
...
function mergeMattermostAccountConfig(cfg, accountId) {
	return resolveMergedAccountConfig({
		channelConfig: cfg.channels?.["mattermost-pro"],
		accounts: cfg.channels?.["mattermost-pro"]?.accounts,
		accountId,
...
function resolveMattermostAccount(params) {
	...
	const baseEnabled = params.cfg.channels?.["mattermost-pro"]?.enabled !== false;
	...
	const configToken = params.allowUnresolvedSecretRef ? normalizeSecretInputString(merged.botToken) : normalizeResolvedSecretInputString({
		...
		path: `channels.mattermost-pro.accounts.${accountId}.botToken`
	});
...
const MATTERMOST_TEXT_CHUNK_LIMIT = 14e3;
//#endregion
export { hasConfiguredSecretInput as C, buildSecretInputSchema as S, normalizeMattermostBaseUrl as _, resolveMattermostReplyToMode as a, updateMattermostPost as b, createMattermostDirectChannelWithRetry as c, fetchMattermostChannel as d, fetchMattermostChannelByName as f, fetchMattermostUserTeams as g, fetchMattermostUserByUsername as h, resolveMattermostAccount as i, createMattermostPost as l, fetchMattermostUser as m, listMattermostAccountIds as n, MattermostPostSchema as o, fetchMattermostMe as p, resolveDefaultMattermostAccountId as r, createMattermostClient as s, MATTERMOST_TEXT_CHUNK_LIMIT as t, deleteMattermostPost as u, readMattermostError as v, uploadMattermostFile as x, sendMattermostTyping as y };
