...
const mattermostAccountHelpers = createAccountListHelpers("mattermost-pro", {
...
function mergeMattermostAccountConfig(
  ...
  return resolveMergedAccountConfig<MattermostAccountConfig>({
    channelConfig: cfg.channels?.["mattermost-pro"] as MattermostAccountConfig | undefined,
    accounts: cfg.channels?.["mattermost-pro"]?.accounts as
